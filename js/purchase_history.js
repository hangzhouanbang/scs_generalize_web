...
var data,tr;
function init(page){
    ajax_method(map.localurl+map.queryclubcardrecord,'token='+localStorage.getItem('token')+'&type=购买&page='+page+'&size=15','post',function successCallBack(a){
...
if(getScrollTop() + getClientHeight() == getScrollHeight()) {
    vid++;
    ajax_method(map.localurl+map.queryclubcardrecord,'token='+localStorage.getItem('token')+'&type=购买&page='+vid+'&size=15','post',function successCallBack(a){
        data = JSON.parse(a).data.items;
